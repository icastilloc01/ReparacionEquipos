 ...
 * @author icasc
 */
public class GestionEmpleadoNuevo extends javax.swing.JFrame {

    /**
     * Creates new form GestionEmpleadoNuevo1
     */
    public GestionEmpleadoNuevo() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            dao.EmpleadoDAO.insertarEmpleado(e);
        } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionEmpleadoNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionEmpleadoNuevo().setVisible(true);
            }
        });
    }
